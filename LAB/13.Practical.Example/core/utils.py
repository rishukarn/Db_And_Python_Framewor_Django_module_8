...
def send_activation_email(recipient_email,activation_url):
    ...
    from_email='no_replay@demomailtrap.co'
    to_email=[recipient_email] 

    html_content=render_to_string('core/activation.html',{'activation_url':activation_url})
...
def send_reset_password_email(recipient_email,reset_url):
    ...
    html_content=render_to_string('core/restmail.html',{'reset_url':reset_url})
    text_content=strip_tags(html_content)
